                ...
                <form method="POST" action="{{ route('auth.register.save') }}" class="space-y-4" id="registrationForm">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <div class="space-y-1">
                            ...
                            <input type="text" name="fname" value="{{ old('fname') }}" class="w-full px-3 py-2 border rounded-md focus:ring-2 focus:ring-pink-300 focus:border-pink-400" required>
                        </div>
                        <div class="space-y-1">
                            <label class="text-sm font-medium text-gray-600">Middle Name</label>
                            <input type="text" name="mname" value="{{ old('mname') }}" class="w-full px-3 py-2 border rounded-md focus:ring-2 focus:ring-pink-300 focus:border-pink-400">
                        </div>
                        <div class="space-y-1">
                            <label class="text-sm font-medium text-gray-600">Last Name</label>
                            <input type="text" name="lname" value="{{ old('lname') }}" class="w-full px-3 py-2 border rounded-md focus:ring-2 focus:ring-pink-300 focus:border-pink-400" required>
                        </div>
                    </div>
                    ...
                    <div class="space-y-1">
                        ...
                        <input type="email" name="email" class="w-full px-3 py-2 border rounded-md focus:ring-2 focus:ring-pink-300 focus:border-pink-400" required>
                    </div>

                    <!-- Password -->
                    <div class="space-y-1">
                        <label class="text-sm font-medium text-gray-600">Password</label>
                        <input type="password" name="password" id="password" class="w-full px-3 py-2 border rounded-md focus:ring-2 focus:ring-pink-300 focus:border-pink-400" required>
                        <p id="passwordError" class="text-red-500 text-sm hidden">Password must be at least 8 characters long, contain an uppercase letter, lowercase letter, number, and special character.</p>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div class="space-y-1">
                            ...
                            <input type="number" name="mobile_no" value="{{ old('mobile_no') }}" class="w-full px-3 py-2 border rounded-md focus:ring-2 focus:ring-pink-300 focus:border-pink-400" required>
                        </div>
                        <div class="space-y-1">
                            <label class="text-sm font-medium text-gray-600">Age</label>
                            <input type="number" name="age" value="{{ old('age') }}" class="w-full px-3 py-2 border rounded-md focus:ring-2 focus:ring-pink-300 focus:border-pink-400" required>
                        </div>
                    </div>
                    ...
                    <div class="space-y-1">
                        ...
                        <select name="gender" class="w-full px-3 py-2 border rounded-md focus:ring-2 focus:ring-pink-300 focus:border-pink-400" required>
                            <option value="male" {{ old('gender') == 'male' ? 'selected' : '' }}>Male</option>
                            <option value="female" {{ old('gender') == 'female' ? 'selected' : '' }}>Female</option>
                        </select>
                    </div>

                    <button type="submit" id="submitBtn" class="w-full bg-pink-600 text-white py-2 px-4 rounded-md hover:bg-pink-700 transition-colors">
                        Continue
                    </button>
                </form>
