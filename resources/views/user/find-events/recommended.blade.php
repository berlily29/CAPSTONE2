<div class="mb-4 text-center">
    ...
    <div id="popup-loader" class="py-8 popup-loader hidden flex justify-center items-center bg-opacity-50 z-50">
        ...
        <div class="card">
            ...
            <div class="loader">
                <div
                    ...
                    <div
                        class="rounded-full h-full w-full bg-slate-100 dark:bg-zinc-900 background-blur-xl"></div>
                </div>

            </div>
            <h1 class="text-center text-gray-400 mt-4">Generating an event....</h1>
        </div>
    ...
    <div id="recommendation" class="mt-6 hidden">
        <div class="group relative bg-white rounded-2xl shadow-sm transition-all border border-gray-100 hover:border-pink-100 overflow-hidden">
            ...
            <div class="pl-6 pr-4 py-6 flex flex-col items-center gap-4">
                ...
                <span id="unavailable" class="hidden text-center my-4 italic text-gray-400 text-lg"> No events available at the moments... Please try again later..</span>
                <!-- Event Details -->
                <div class="flex flex-col" id="available">
                ...
                <!-- Action Buttons -->
                <div class="flex gap-3" id="available">
        ...
        fetch("{{ route('find-events.getNewRecommendation') }}")
            ...
            .then(data => {
                if (data.success == false) {
                    ...
                    let avails = document.querySelectorAll("#available")
                    console.log(avails)
                    avails.forEach(avail => {
                        avail.classList.add('hidden'); // Example: Log each element's text
                    });
