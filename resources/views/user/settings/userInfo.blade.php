...
<div class="mt-4 text-center w-full flex flex-row-reverse">
    <button id="editButton" class="w-96 bg-pink-500  text-white py-3 rounded-md hover:bg-pink-600 transition-colors text-sm">
        Edit
    </button>
