    ...
    <div class="min-h-screen bg-white p-8 rounded-lg">
        ...
        <section class="bg-white p-6 rounded-lg border border-gray-200 mt-4 hidden" id="section_unlocked">
            ...
            <div class="mb-4 text-center">
                ...
                <span id = "unavailable" class="hidden text-center my-4 italic text-gray-400 text-lg"> No events available at the moment...</span>

                <!-- Loader -->
                <div id="popup-loader" class="popup-loader hidden flex justify-center items-center bg-opacity-50 z-50">
                    <div class="card">
                        <div class="loader">
