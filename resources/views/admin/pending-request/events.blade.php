<x-app-layout>
    <div class="py-8 px-10 bg-white border-b border-gray-200 rounded-lg">
        ...
        <div class="mb-4">
            ...
            <h1 class="text-3xl font-black text-gray-700">Events Approval</h1>
        </div>
                            ...
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm">
                                    <div class="flex gap-2 justify-end">
                                        <button onclick="openEventPopup('{{ route('admin.pending-request.event.view-event', $event->event_id) }}')"
