...
<body style="background-color: #f472b6; padding: 24px; font-family: Arial, sans-serif;">
    <div style="max-width: 600px; margin: auto; background-color: #ffffff; border-radius: 8px; box-shadow: 0 2px 5px rgba(0, 0, 0, 0.1); padding: 24px;">
        <h1 style="font-size: 24px; font-weight: bold; color: #1f2937;">You are permanently banned!</h1>
        <p style="margin-top: 16px; color: #4b5563;">Dear {{ $user->fname }} {{ $user->lname }},</p>
        <p style="margin-top: 16px; color: #4b5563;">We regret to inform you that we have to ban you in  Applying Event Organizer.</p>
        <p style="margin-top: 16px; color: #4b5563;">Reason for banning: <strong> Multiple attempts and rejection</strong></p>
