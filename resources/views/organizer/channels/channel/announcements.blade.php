<div class="">
    ...
    <div class="w-full flex ">
        <a href = "{{route('eo.channels.post.view',['id'=> $event->event_id])}}" class="mt-2 flex justify-center items-center py-2 px-12 rounded-md bg-gray-400 gap-2 text-white transition duration-200 ease-in-out hover:bg-gray-500">
